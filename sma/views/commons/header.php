...
<?php if ($this->ion_auth->in_group(array('owner', 'admin'))) { ?>
    ...
    <?php } ?>
                                    ...
                                    <li><a href="<?php echo base_url(); ?>index.php?module=waiters">Daftar Waiters</a></li>
                                    <li><a href="<?php echo base_url(); ?>index.php?module=waiters&amp;view=add">Tambahkan Waiters Baru</a></li>
                                    <li class="divider"></li>
    ...
    <?php if ($this->ion_auth->in_group('owner')) { ?>
                        ...
                        <?php } ?>
                        <li class="dropdown"><a class="showSubMenus" href="#HistoryMenu"><i class="icon-barcode icon-white"></i> History <b class="caret"></b></a>
                        <ul class="nav nav-tabs nav-stacked sub-menu" id="HistoryMenu">
                            <li><a href="<?php echo base_url(); ?>index.php?module=products&view=log">Log History Transaksi</a></li>
                        </ul>
                    </li>
                            <li class="dropdown"><a class="showSubMenus" href="#reportsMenu"><i class="icon-tasks  icon-white"></i> <?php echo $this->lang->line('reports'); ?> <b class="caret"></b></a>
                                <ul class="nav nav-tabs nav-stacked sub-menu" id="reportsMenu">
                                    ...
                                    <li><a href="<?php echo base_url(); ?>index.php?module=reports&view=purchases"><?php echo $this->lang->line('purchase_reports'); ?></a></li>
