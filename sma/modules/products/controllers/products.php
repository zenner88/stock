...
*/
	...
	function getdatatableajaxcost()
   {
	   ...
	   $this->datatables
			...
			// ->join('warehouses_products', 'products.id=warehouses_products.product_id', 'INNER')
   ...
   function getwhproducts($warehouse_id = NULL)
   {
	   ...
	   $this->datatables
			...
			<a href='index.php?module=products&view=edit&id=$1&code=$3' class='tip' title='".$this->lang->line("edit_product")."'><i class='icon-edit'></i></a>
	...
	function getseatchresults($srq = NULL)
   {
	   ...
	   $this->datatables
			...
			"<center><a href='#' onClick=\"MyWindow=window.open('index.php?module=products&view=barcode&code=$3', 'MyWindow','toolbar=no,location=no,directories=no,status=no,menubar=no,scrollbars=yes,resizable=yes,width=425,height=275'); return false;\">
								...
								<a href='index.php?module=products&view=edit&id=$1&code=$3'>
	...
	function add()
	{
		...
		$this->form_validation->set_rules('jml_cf1', $this->lang->line("jml_pcf1"), 'xss_clean');
		$this->form_validation->set_rules('jml_cf2', $this->lang->line("jml_pcf2"), 'xss_clean');
		$this->form_validation->set_rules('jml_cf2', $this->lang->line("jml_pcf3"), 'xss_clean');
		$this->form_validation->set_rules('jml_cf4', $this->lang->line("jml_pcf4"), 'xss_clean');
		$this->form_validation->set_rules('jml_cf5', $this->lang->line("jml_pcf5"), 'xss_clean');
		$this->form_validation->set_rules('jml_cf6', $this->lang->line("jml_pcf6"), 'xss_clean');
		$this->form_validation->set_rules('menu', $this->lang->line("menu"), 'xss_clean');
		...
		if ($this->form_validation->run() == true)
		{
			...
			$data = array('code' => $code,
				...
				'jml_cf1' => $this->input->post('jml_cf1'),
				'jml_cf2' => $this->input->post('jml_cf2'),
				'jml_cf3' => $this->input->post('jml_cf3'),
				'jml_cf4' => $this->input->post('jml_cf4'),
				'jml_cf5' => $this->input->post('jml_cf5'),
				'jml_cf6' => $this->input->post('jml_cf6'),
		...
		{  
			...
			$data['jml_cf1'] = array('name' => 'jml_cf1',
				'id' => 'jml_cf1',
				'type' => 'text',
				'value' => $this->form_validation->set_value('jml_cf1')
			);
			$data['jml_cf2'] = array('name' => 'jml_cf2',
				'id' => 'jml_cf2',
				'type' => 'text',
				'value' => $this->form_validation->set_value('jml_cf2')
			);
			$data['jml_cf3'] = array('name' => 'jml_cf3',
				'id' => 'jml_cf3',
				'type' => 'text',
				'value' => $this->form_validation->set_value('jml_cf3')
			);
			$data['jml_cf4'] = array('name' => 'jml_cf4',
				'id' => 'jml_cf4',
				'type' => 'text',
				'value' => $this->form_validation->set_value('jml_cf4')
			);
			$data['jml_cf5'] = array('name' => 'jml_cf5',
				'id' => 'jml_cf5',
				'type' => 'text',
				'value' => $this->form_validation->set_value('jml_cf5')
			);
			$data['jml_cf6'] = array('name' => 'jml_cf6',
				'id' => 'jml_cf6',
				'type' => 'text',
				'value' => $this->form_validation->set_value('jml_cf6')
			);
			$data['menu'] = array('name' => 'menu',
				'id' => 'menu',
				'type' => 'text',
		...
		$data['pororos'] = $this->products_model->getAllPororos();		
		$data['pororosById'] = $this->products_model->getAllPororosById();		
	...
	function edit()
	{
		...
		$bom_details = $this->products_model->getAllBomByID($this->input->get('code'));
		$data['categories'] = $this->products_model->getAllCategories();
		$data['tax_rates'] = $this->products_model->getAllTaxRates();
