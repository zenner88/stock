...
<div class="control-group">
  <label class="control-label" id="tax_rate">Menu Resto</label>
  <div class="controls">  <?php 
	   		
				$xx[1] = YA;
				$xx[0] = TIDAK;        
			
		echo form_dropdown('menu', $xx, (isset($_POST['menu']) ? $_POST['menu'] : ""), 'id="menu" data-placeholder="Menu Resto ?" required="required" '); ?> </div>
</div>        
...
<div class="control-group">
    ...
    <option value="">--Pilih Bahan Baku--</option>
            <?php foreach($pororos as $pororo){
							// [$pororo->id] = $tax->name;
                echo '<option value="'.$pororo->code.'">'.$pororo->name.'</option>';
            } ?>
            </select>
