...
body { text-align:center; color:#000; font-family: Verdana, Geneva, sans-serif; font-size:12px; }
...
@media print {
	...
	#wrapper { max-width: 300px; width: 100%; margin: 0 auto; font-size:10px; }
...
<img src="<?php echo $this->config->base_url(); ?>assets/uploads/logos/<?php echo $biller->logo; ?>" alt="Biller Logo">
    ...
    echo '<div style="clear:both;"></div>';
	echo "<span class=\"left\">Pelayan: ". $inv->pelayan."</span> 
	<span class=\"right\">No Meja: ".$inv->noMeja."</span>"; 
	 ?>
    ...
    <tr>    
    <td colspan="2" style="text-align:left; font-weight:bold; padding-top:5px;"><?php echo $this->lang->line("paid"); ?></td><td colspan="2" style="padding-top:5px; text-align:right; font-weight:bold;"><?php echo $this->ion_auth->formatMoney($inv->paid); ?></td>
    </tr>
...
<?php } ?>  
    ...
    <div style="clear:both;"></div>
    <a href="<?php echo base_url(); ?>index.php?module=pos&view=Test&id=<?php echo $idSuspended ;?>" style="width:98%; display:block; font-size:12px; text-decoration: none; text-align:center; color:#FFF; background-color:#007FFF; border:2px solid #007FFF; padding: 10px 1px; margin: 5px auto 10px auto; font-weight:bold;"><?php echo $this->lang->line("back_to_pos"); ?></a>
    <div style="clear:both;"></div>
