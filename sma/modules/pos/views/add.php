                ...
                <div class="navbar-inner" style="padding-left:10px;">
                    ...
                    <div class="nav-collapse collapse">
                        ...
                        <ul class="nav pull-right">
                            ...
                            <li><a class="btn btn-success hbtn" href="index.php?module=pos&view=today_sale" ><?php echo $this->lang->line('today_sale'); ?></a></li>
                            <?php
                            if (ALERT_NO > 0) {
...
?>
                                ...
                                <div id="lefttop">
                                    ...
                                    <input value="<?php echo $noMeja->namaCustomer; ?>" id="customer" name="customer" class="customer" style="width:330px;float: left;" placeholder="Customer - Type 2 char for suggestions" onClick="this.select();">
                                    ...
                                    <tr>
                                    <td>
                                    <input id="scancode" name="code" class="scancode" style="width:250px; border: 1px solid #00ACED; color: #00ACED;" placeholder="<?php echo $this->lang->line('barcode_scanner'); ?>" autocomplete="off">
                                    </td>
                                    <td>No Meja :
                                    <input id="noMeja" name="noMeja" value="<?php echo $noMeja->noMeja; ?>" class="keyboard" style="width:100px; border: 1px solid #00ACED; color: #00ACED;" placeholder="No Meja" autocomplete="off">
                                    </td>
                                    ...
                                    <tr>
                                        ...
                                        <option   value="">--Pillih Pelayan--</option>

                                        <?php
                                        foreach($waiter as $wait){

                                            if($wait->id == $noMeja->pelayan){
                                                echo ' Waiters : <option value="'.$noMeja->pelayan.'" selected>'.$wait->nama.'</option>';
                                            }

                                            echo ' Waiters : <option value="'.$wait->id.'">'.$wait->nama.'</option>';
                                    ...
                                    <!-- <input id="scancode" name="code" class="scancode" style="width:185px; border: 1px solid #00ACED; color: #00ACED;" placeholder="<?php echo $this->lang->line('barcode_scanner'); ?>" autocomplete="off">
                                    <input id="scancode" name="code" class="scancode" style="width:185px; border: 1px solid #00ACED; color: #00ACED;" placeholder="No Meja" autocomplete="off"> -->
                                            ...
                                            <table id="title_table" border="0" cellpadding="0" cellspacing="0">
                                                <thead>
                                                    <tr>
                                                        ...
                                                        <th style="width: 30px; color:#FFF;padding:5px 0; font-weight:normal;"><i class="icon-print icon-white"></i></th>
                                                    </tr>
                                                </thead>
                                            </table>
                                        </div>
                                     ...
                                     $.ajax({
                                         ...
                                         success: function(data) {
                                             if (data != null) {
                                                ...
                                                //  if (data.g_total != null) {
                                                    //  noMeja = parseFloat(data.g_total);
                                                //  } else {
                                                    //  noMeja = '';
                                                //  }
                                             } else {
