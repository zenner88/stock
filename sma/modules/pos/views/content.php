...
<script>
             $(document).ready(function() {
                ...
                $('#fileData').dataTable( {
					"aLengthMenu": [[10, 25, 50, 100, "All"], [10, 25, 50, 100, "All"]],
                    "aaSorting": [[ 0, "desc" ]],
					...
					"aoColumns": [ 
					 { "mRender": format_date }, null, null, null, { "mRender": currencyFormate }, { "mRender": currencyFormate }, { "mRender": currencyFormate }, { "mRender": currencyFormate },
					  { "bSortable": false }
					]
...
<table id="fileData" class="table table-bordered table-hover table-striped table-condensed" style="margin-bottom: 5px;">
        ...
        <tr>
            ...
            <th><?php echo $this->lang->line("No Meja"); ?></th>
