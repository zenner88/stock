...
//index or inventories page
   ...
   function getdatatableajax()
   {
	   ...
	   $this->datatables
			...
			"<center><a href='#' onClick=\"MyWindow=window.open('index.php?module=sales&view=view_struk&id=$1', 'MyWindow','toolbar=0,location=0,directories=0,status=0,menubar=yes,scrollbars=yes,resizable=yes,width=1000,height=600'); return false;\" title='".$this->lang->line("view_struk")."' class='tip'><i class='icon-print'></i></a> <a href='#' onClick=\"MyWindow=window.open('index.php?module=sales&view=view_invoice&id=$1', 'MyWindow','toolbar=0,location=0,directories=0,status=0,menubar=yes,scrollbars=yes,resizable=yes,width=1000,height=600'); return false;\" title='".$this->lang->line("view_invoice")."' class='tip'><i class='icon-fullscreen'></i></a> 
...
//view inventory as html page
   ...
   function view_struk()
   {
      ...
      $this->load->view('view_struk', $data);
