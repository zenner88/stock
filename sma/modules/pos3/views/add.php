...
?>
                                ...
                                <div id="lefttop">
                                    ...
                                    <td>
                                    <input id="noMeja" name="noMeja" class="keyboard" style="width:100px; border: 1px solid #00ACED; color: #00ACED;" placeholder="No Meja" autocomplete="off">
                                    </td>
...
$fetch_nurse_name = mysql_query("SELECT * FROM waiters");


while($throw_nurse_name = mysql_fetch_array($fetch_nurse_name)) {
echo '<option   value="'.$throw_nurse_name['id'].'">'.$throw_nurse_name['nama'].'</option>';
}
echo "</select>";
