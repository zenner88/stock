...
<script>
             $(document).ready(function() {
                $('#fileData').dataTable( {
					...
					'bProcessing'    : true,
					'bServerSide'    : true,
					'sAjaxSource'    : '<?php echo base_url(); ?>index.php?module=waiters&view=getdatatableajax',
...
<?php if($message) { echo "<div class=\"alert alert-error\"><button type=\"button\" class=\"close\" data-dismiss=\"alert\">&times;</button>" . $message . "</div>"; } ?>
	...
	<h3 class="title">Daftar Waiters</h3>
	...
	<p><a href="<?php echo site_url('module=waiters&view=add');?>" class="btn btn-primary">Tambahkan Waiters</a></p>
